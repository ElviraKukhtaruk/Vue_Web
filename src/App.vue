...
import BackgroundVariable from '@/components/Home/BackgroundVariable.vue';
...
<template>
  <Layout>
    <template #content>
      ...
      <BackgroundVariable :image="bg2">
        <About />
      </BackgroundVariable>
      <BackgroundVariable :image="bg3">
        <Start />
      </BackgroundVariable>
      <BackgroundVariable :image="bg4">
        <Contact />
      </BackgroundVariable>
      <BackgroundVariable>
        <Pricing />
